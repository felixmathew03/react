...
function App() {
  ...
  <>
    ...
    <div className='m-auto p-8 border-cyan-400 rounded-xl shadow-2xl w-1/4 h-1/4 bg-no-repeat brightness-95 bg-scroll text-white bg-center bg-cover shadow-neutral-900 drop-shadow-xl grayscale hover:grayscale-0 origin-bottom rotate-12 transition ease-out hover:-rotate-12 ' style={{backgroundImage:`url(images/bg2.avif)`}}>
...
Thank you.
    ...
    <table class="table-auto border border-slate-500 mt-8 border-separate border-spacing-4  m-auto">
...
<button class="mx-96 p-2 rounded-md   transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 ">
  Save Changes
